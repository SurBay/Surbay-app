...
public class GeneralReplyListViewAdapter extends RecyclerView.Adapter<GeneralReplyListViewAdapter.MyViewHolder> {
    ...
    public GeneralReplyListViewAdapter(Context ctx, ArrayList<Reply> listViewItemList) {
    ...
    @Override
    public GeneralReplyListViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = inflater.inflate(R.layout.detail_reply_list_item, parent, false);
        GeneralReplyListViewAdapter.MyViewHolder holder = new GeneralReplyListViewAdapter.MyViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(GeneralReplyListViewAdapter.MyViewHolder holder, int position) {
        ...
        holder.comment.setBackgroundColor(context.getResources().getColor(R.color.gray_FB));
                                    ...
                                    customDialog = new CustomDialog(context, new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            new Thread(new Runnable() {
                                                @Override
                                                public void run() {
                                                    String requestURL = context.getString(R.string.server)+"/api/generals/deletecomment/"+post.getID();
                                                    try{
    ...
    private void updateReplyReports(int position, String comment_id) throws Exception {
        String requestURL = context.getString(R.string.server) + "/api/generals/reportcomment/" + post.getID();
        try {
            RequestQueue requestQueue = Volley.newRequestQueue(context);
            JSONObject params = new JSONObject();
